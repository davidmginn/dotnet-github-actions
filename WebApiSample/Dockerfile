...
RUN dotnet build "WebApiSample.csproj" -c $configuration -o /app/build

FROM build AS publish
ARG configuration=Release
RUN dotnet publish "WebApiSample.csproj" -c $configuration -o /app/publish /p:UseAppHost=false
